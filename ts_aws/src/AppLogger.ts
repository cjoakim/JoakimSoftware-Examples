/**
 * Lightweight and configurable logger class; optionally
 ...
 * in the package.  Each application class is assigned a default
    ...
    error(message : string) {
        if (this.winstonLogger) {
            ...
            if (this.normalLevel <= AppLogger.LOG_LEVELS.error) {
                this.errorLogged++;
                console.log(util.format('%s error: %s', this.name, message));
            }
        }
    }
    ...
    warn(message : string) {
        if (this.winstonLogger) {
            ...
            if (this.normalLevel <= AppLogger.LOG_LEVELS.warn) {
                this.warnLogged++;
                console.log(util.format('%s warn: %s', this.name, message));
            }
        }
    }
    ...
    info(message : string) {
        if (this.winstonLogger) {
            ...
            if (this.normalLevel <= AppLogger.LOG_LEVELS.info) {
                this.infoLogged++;
                console.log(util.format('%s info: %s', this.name, message));
            }
        }
    }
    ...
    debug(message : string) {
        if (this.winstonLogger) {
            ...
            if (this.normalLevel <= AppLogger.LOG_LEVELS.debug) {
                this.debugLogged++;
                console.log(util.format('%s debug: %s', this.name, message));
            }
        }
    }
    ...
    errorException(excp: any) {
        if (this.winstonLogger) {
            ...
            if (this.exceptionLevel <= AppLogger.LOG_LEVELS.error) {
                this.errorLogged++;
                console.log(util.format('%s error: %s', this.name, excp));
            }
        }
    }
    ...
    warnException(excp: any) {
        if (this.winstonLogger) {
            ...
            if (this.exceptionLevel <= AppLogger.LOG_LEVELS.warn) {
                this.warnLogged++;
                console.log(util.format('%s warn: %s', this.name, excp));
            }
        }
    }
    ...
    infoException(excp: any) {
        if (this.winstonLogger) {
            ...
            if (this.exceptionLevel <= AppLogger.LOG_LEVELS.info) {
                this.infoLogged++;
                console.log(util.format('%s info: %s', this.name, excp));
            }
        }
    }
    ...
    debugException(excp: any) {
        if (this.winstonLogger) {
            ...
            if (this.exceptionLevel <= AppLogger.LOG_LEVELS.debug) {
                this.debugLogged++;
                console.log(util.format('%s debug: %s', this.name, excp));
            }
        }
    }
